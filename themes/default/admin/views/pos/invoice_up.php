        ...
        <div style="width:100%; margin:0px auto !important;">
            ...
            <div class="">
                <div class="pull-center" style="margin: 0 auto; text-align: center;">
                    <img style="width:100%; margin-top:-3px;" src="<?php echo base_url();?>/assets/uploads/logos/<?= $biller->logo ?>">
                </div>
                       ...
                       <!--  <div class="pull-left">
                        ...
                        <table class=''>
                               <!--  <tr style="color: blue !important">
                                ...
                                <tr>
                                    <td align="left" style="vertical-align: top !important;font-size:10px !important;font-family:kh_content;">invoice No<!-- No:  --></td>
                              ...
                              <!--   <tr>
                                ...
                                <tr>
                                        <td align="left" style="font-size:10px;font-family:kh_content;">Invoice Date </td>
                                        <td width="10"></td>
                            ...
                            <div class="text-right"  style="​">
                                <table class=''>                   
                                    ...
                                    <tr​​>
                                        ...
                                        <td width="10"></td>
                                        <td align="left" style="font-size:10px;"><?= lang( $customer->address); ?></td>
                                    </tr>
                                     <?php if($biller->id==4){ ?>
                                    <tr>
			...
			?>
                ...
                <tr style="padding-top: 20px !important;margin-bottom:-10px;">
                    ...
                    <!-- <th colspan="6"></th> -->
                    <?php $date=date('Y-m-d');?>
                    <th colspan="3" rowspan="5" style="font-family:kh_content;border-bottom:none !important;border-right:none !important; border-left: none !important;font-weight:none !important;font-weight:normal !important;"><br>
                        <p style="text-align: left;font-size:12px !important;font-weight: normal !important;"><span>ថ្ងៃទី............ខែ............ឆ្នាំ២០១.......</span><br><span>ចំណាំ ប្រាក់កក់រួចមិនអាចយកវិញបានទេ</span><br><span>Note: Deposit is not returnable</span></p>
                    </th>
