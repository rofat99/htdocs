...
// }
$rate = $this->db->where('id',2)->get('currencies')->row();
if ($modal) {
...
<div id="wrapper">
    ...
    <style type="text/css">
        ...
        <div class="text-center">
            <img class="hide" src="<?= base_url() . 'assets/images/logo.png'; ?>" alt="<?= $biller->company; ?>" style='height:70px;'>

            <h3 style="text-transform:uppercase;"><?= $biller->company != '-' ? $biller->company : $biller->name; ?></h3>
            <p class="adr" style="text-aling:center"><?php echo $biller->address?></p>
            ...
            echo "<div style='float: left; font-size:9px'>";
                ...
                echo lang("cashier");
            echo "</div>";
            echo "<div style='float: left; margin-left:20px; font-size:9px;'>";
            ...
            <table class="table table-striped table-condensed">
                ...
                foreach ($rows as $row) {
                    ...
                    echo '<tr>';
                            echo '<td colspan="3"><span style="margin:0px 5px 0px 10px">'.$r.'</span>'. $row->product_name .'</td>';
                ...
                <tr style="padding-bottom: 20px !important;">
                    <th colspan="2">Exch rate : <?php echo $this->sma->formatMoney($rate->rate);?> </th>
                    <th class="text-right" colspan="2" style="white-space: nowrap !important;"><?= lang("subtotalr"); ?></th>
                ...
                // echo $inv->exchange_rate.'exchage_rate';
                // print_r($inv);
                ...
                <?php } else { ?>
                    <tr>
                        ...
                        <th class="text-center"><?= $this->sma->formatMoney($inv->grand_total); ?></th>
                    ...
                    <tr>
                        ...
                        <th style="text-align:center;">$</th>
                        <th class="text-center"><?= $paid_amount=$this->sma->formatMoney($payments[0]->pos_paid == 0 ? $payments[0]->amount : $payments[0]->pos_paid) . ($payments[0]->return_id ? ' (' . lang('returned') . ')' : '') ; ?></th>
                        <th class="text-right">R</th>
                    ...
                    <tr style="border-bottom:dotted 2px black !important;">
                        ...
                        <th style="text-align:center;">$</th>
                        <th class="text-center"><?= ($payments[0]->pos_balance > 0 ? $this->sma->formatMoney($payments[0]->pos_balance) : 0) ; ?></th>
                        <th class="text-right">R</th>
