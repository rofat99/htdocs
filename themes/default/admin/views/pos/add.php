...
<div class="rotate btn-cat-con">
    <button type="button" id="open-brands" class="btn btn-info open-brands hide"><?= lang('table'); ?></button>
                        ...
                        <div class="font16">
                            <table class="table table-bordered table-condensed table-striped" style="margin-bottom: 0;">
                                ...
                                <tr>
                                    ...
                                    <td><span id="total_payable_r">0.00</span><span>(Riel)</span></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><span id="balance_r">0.00</span><span>(Riel)</span></td>
                                </tr>
                                </tbody>
                            </table>
                            <div class="clearfix"></div>
