            ...
            <div class="col-lg-12">
                ...
                <div class="well well-sm no-print">
                    ...
                    <div class="controls table-controls">
                        ...
                        <div class="form-group">
                            <?= lang('style', 'style'); ?>
                            <?php $opts = array('' => lang('select').' '.lang('style'), 40 => lang('40_per_sheet'), 30 => lang('30_per_sheet'), 24 => lang('24_per_sheet'), 20 => lang('20_per_sheet'), 18 => lang('18_per_sheet'), 14 => lang('14_per_sheet'), 12 => lang('12_per_sheet'), 10 => lang('2_per_sheet'), 50 => lang('continuous_feed')); ?>
                ...
                <div id="barcode-con">
                    <?php
                        if ($this->input->post('print')) {
                            if (!empty($barcodes)) {
                                echo '<button type="button" onclick="window.print();return false;" class="btn btn-primary btn-block tip no-print" title="'.lang('print').'"><i class="icon fa fa-print"></i> '.lang('print').'</button>'. '<br>';
                                ...
                                foreach ($barcodes as $item) {
                                    ...
                                    for ($r = 1; $r <= $item['quantity']; $r++) {
                                        echo '<div style="" class="item style'.$style.'" '.
                                        ...
                                        if($item['price']) {
                                            echo '<span class="barcode_prices">'.lang(' $').' ';
                                            if($item['currencies']) {
                                        ...
                                        echo '<span class="">'.$item['code'].'</span>';
