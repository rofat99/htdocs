                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-5">
                                                                               ...
                                                                               <!--  <div class="col-md-6">
                                                                                ...
                                                                                <div class="col-md-6 hide">
                                                                                    <label class="checkbox" for="notify">
                                                                                        <input type="checkbox" name="invoice" value="1" id="invoice" checked="checked"/>
                                                                                        <?= lang('print_invoice') ?>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                            ...
                                            <?php } ?>
                                             <div class="form-group">
                                                    <label class="checkbox" for="notify">
                                                        <input type="checkbox" name="receipt" <?= $user->print_receipt==1?'checked':''?> id="receipt" />
                                                        <?= lang('print_receipt') ?>
                                                    </label>
                                                </div>
                                        </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="no">
                                                                            ...
                                                                            <div class="row">
                                                                               <!--  <div class="col-md-6">
                                                                                    <label class="checkbox" for="notify">
                                                                                        <input type="checkbox" name="receipt" value="<?php echo $user->print_receipt?>" id="receipt" checked="checked"/>
                                                                                        <?= lang('print_receipt') ?>
                                                                                    </label>
                                                                                </div> -->
                                                                                <div class="col-md-6 hide">
