                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <th><?php echo $this->sma->formatMoney($total_usd);?>($)</th>
                                <th><?php echo $this->sma->formatMoney($det_re->paid);?>($)</th>
                                <td><?php echo $this->sma->formatMoney($total_remain); ?>($)</td>
                    ...
                    <table class="table table-bordered" style="background: white !important">
                        <tbody class="hide">
                            <tr>
                                ...
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?= $this->sma->formatMoney($total_am); ?>&nbsp;($)</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?= $this->sma->formatMoney($remain);?>&nbsp;($)</td>
