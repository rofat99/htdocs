        ...
        <div style="width:100%; margin:0px auto !important;">
            ...
            <div class="col-md-12">
                <div class="pull-center" style="margin: 0 auto; text-align: center;">
                    <div class="col-md-4">
                        <img style="width:25%; margin-top:-12px; float:left;" src="<?php echo base_url();?>/assets/uploads/logos/Delivery.png?>">
                    </div>
            ...
            <div class="padding10">               
                    ...
                    <p style="font-size: 16px;font-weight: bold; height: 5px;"></p>
                     ...
                     <div class="" style="margin-bottom:0px;margin-top:-21px;">
                        ...
                        <div class="pull-right" style="border:1px solid #ddd;padding:10px;">
                        <table class=''>
                                <tr>
                                ...
                                <tr>
                                    <td align="left" style="font-size:10px;">Note :</td>

                                    <td style="padding-bottom: 0px;" width="10"></td>
                                    <td style="padding-bottom: 0px;" align="left"><?= $this->sma->decode_html($inv->note); ?></td>
                                </tr>
                                <!-- <tr>
                            ...
                            <div class="text-right"  style="">
                                <table class=''>                                
                                    ...
                                    <tr>
                                     ...
                                     <?php if($biller->id==4){ ?>
                                    <tr>
                                        <td style="padding-bottom: 0px;font-size:10px;" align="left">Address : </td>
                                        <td style="padding-bottom: 0px;" width="10"></td>
            ...
            <style type="text/css">
                ...
                <tbody>
                    ...
                    foreach ($rows as $row):
                        ...
                        ?>
                        <tr>
                            <td style="text-align:center; width:40px; vertical-align:middle;font-family: kh_content;font-size:10px;line-height:20px;"><?= $r; ?></td>
                            <!-- <td style="width:40px; vertical-align:middle;"><?= $row->product_code;?></td> -->
                            <td style="vertical-align:middle; width:350px !important; font-family: kh_content;font-size:10px;line-height:20px;"><?= $row->product_name ?></td>
                            <td style="width: 50px; text-align:center; vertical-align:middle;white-space: nowrap;font-family: kh_content;font-size:10px;line-height:20px;"><?php echo  number_format($row->unit_quantity,0).''.$unit; //$this->sma->formatNumber($row->quantity); ?></td>
                            ...
                            <?php if(($inv->total_tax_usd!=0 || $inv->total_tax_b!=0) && $biller->id==4) {?>
                                <td style="text-align:right; width:100px;font-size:10px;line-height:20px;"><?= $this->sma->formatMoney(($base_price/1.1)).$cur; ?></td>
                            <?php }else{ ?>
                                <td style="text-align:right; width:50px;font-size:10px;line-height:20px;"><?= number_format($row->unit_price,0).$cur; ?>&nbsp;$</td>
                                <?php } ?>
                            ...
                            <?php }else{ ?>
                            <td colspan='2' style="text-align:right; width:70px;font-family: kh_content;font-size:10px;line-height:20px;"><?= number_format($subtotal_usd,0) ?>&nbsp;$</td>
            ...
            ?>
                    ...
                    <?php
                        ...
                        <?php if ($inv->shipping != 0) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang("ដឹកជញ្ជួន") . ' (' . $default_currency->code . ')</td><td style="text-align:right; padding-right:10px;">' . $this->sma->formatMoney($inv->shipping,0) .'$'.'</td></tr>';
                        }
                        ?>
                        <?php
                             if ($inv->order_tax != 0) {
                ...
                <tr style="padding-top: 20px !important;margin-bottom:-10px;">
                    ...
                    <!-- <th colspan="6"></th> -->
                    <?php $date=date('Y-m-d');?>
                    <th colspan="3" rowspan="3" style="font-family:kh_content;border-bottom:none !important;border-right:none !important; border-left: none !important;font-weight:none !important;font-weight:normal !important;"><br>
                        <p style="text-align: left;font-size:12px !important;"><span>ថ្ងៃទី............ខែ............ឆ្នាំ201.......</span><br><span>ចំណាំ ប្រាក់កក់រួចមិនអាចយកវិញបានទេ</span><br><span>Note: Deposit is not returnable</span></p>
                ...
                if ($inv->paid < $inv->grand_total) { ?>
                    <tr>
                        <th colspan="0" style="text-align: left !important;font-weight:normal !important;font-family:kh_content;font-size:10px !important;" ><?= lang("លុយបានបង់"); ?></th>
                    ...
                    <tr>
                        ...
                        <th style="font-weight:normal !important;font-family:kh_content;font-size:10px !important; "><?= lang("លុយសល់"); ?></th>
            ...
            <div class="row" align="center" id="rfooter" style="margin-bottom:-5px;">
                <div class="col-xs-6">
                    <p>ហត្ថលេខា & ឈ្មោះអតិថិជន
                    </p>
                </div>
                <div class="col-xs-6">
                    <p>ហត្ថលេខា & ឈ្មោះអ្នកទទួល
                    </p>
                </div>
            </div>
        </div>
