                ...
                <div class="well well-sm no-print">
                    ...
                    <div class="controls table-controls">
                        ...
                        <div class="form-group">
                            ...
                            <input name="check_location" type="checkbox" id="check_location" value="1" checked="checked" style="display:inline-block;" />
                            <label for="check_location" class="padding05"><?= lang('location'); ?></label>
                            ...
                            if (!empty($barcodes)) {
                                ...
                                foreach ($barcodes as $item) {
                                    for ($r = 1; $r <= $item['quantity']; $r++) {
                                        ...
                                        if($item['price']) {
                                            if($item['location']) {
                                                echo $item['location'].'&nbsp&nbsp&nbsp&nbsp';
                                            }
