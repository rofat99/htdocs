                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                $post = array('ordered' => lang('ordered'), 'received' => lang('received'), 'pending' => lang('pending'));
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row" id="extras-con" style="display: none;">
                                ...
                                <!-- <div class="col-md-4">
                                    <div class="form-group">
                                        <?= lang("Insite shipping", "poshipping"); ?>
                                ...
                                <!-- <div class="col-md-4">
                                    <div class="form-group">
                                        <?= lang("Abroad Shipping Date" ,"Abroad Shipping Date");?>
                                        <?php echo form_input('shipping_date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control input-tip datetime" id="shipping_date"'); ?>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?= lang("Abroad Shipping", "abroadhipping"); ?>
                                        <?php echo form_input('abroad_shipping', '', 'class="form-control input-tip" id="abroad_shipping"'); ?>
                                    </div>
                                </div> -->
                            </div>
                            <div class="clearfix"></div>
