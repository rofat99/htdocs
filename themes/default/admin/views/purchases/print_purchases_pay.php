        ...
        <div class="col-md-12" align="center">
            ...
            <!-- <div class="table-responsive"> -->
                <table class="table table-bordered table-hover table-striped" style="background: white !important; margin: 0px !important">
                    <thead style="border:2px solid #34b4d4 !important;background:#34b4d4 !important;">
                    <tr>
                        <th style="background:#34b4d4 !important;"><?= "ល.រ <br> No";//lang("no"); ?></th>
                        <th style="border-left:2px solid #34b4d4 !important;background:#34b4d4 !important;"><?php echo "Date <br> កាលបរិច្ឆេទ"; ?></th>
                        <th style="border-left:2px solid #34b4d4 !important;background:#34b4d4 !important;"><?php echo "លេខ <br> Reference"; ?></th>
                        <th style="border-left:2px solid #34b4d4 !important;background:#34b4d4 !important;"><?= "ដុល្លា <br> USD";//lang("no"); ?></th>
                        <th style="border-left:2px solid #34b4d4 !important;background:#34b4d4 !important;"><?php echo "រៀល <br> RIEL" ?></th>
                    ...
                    <tbody>
                        <?php $i=0;foreach ($voucher_detail as $vd): $i++;?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $this->sma->formatMoney($vd->amount_usd)?>($)</td>
                    ...
                    <table class="table table-bordered" style="background: white !important">
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?= number_format($voucher->amount_usd,2); ?>&nbsp;(USD)</td>
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?php echo $this->sma->formatMoney($voucher->amount_usd*$rate->rate); ?>&nbsp;(R)</td>
                            </tr>
                            <tr>
                ...
                <div class="col-sm-12">
                    <table style="width: 100%">
                        <tr style="height: 100px !important;">
                            ...
                            <td style="vertical-align: top;text-align: center;">
                                <span>ថ្ងៃទី......ខែ.....ឆ្នាំ 201...</span><br>
                                <label style="font-style: bold !important">ហត្ថលេខា & ឈ្មោះអ្នកផ្គត់ផ្គង់</label>
                            </td>
                            <!-- <td style="vertical-align: top;text-align: center;">
                                <span>ថ្ងៃទី......ខែ.....ឆ្នាំ 201...</span><br>
