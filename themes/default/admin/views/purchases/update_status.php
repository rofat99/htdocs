...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            ?>
            <div class="form-group">
            <?= lang("Product Receive Date" ,"Receive Date");?>
            <?php echo form_input('receive_date', (isset($_POST['date']) ? $_POST['date'] : $date), 'class="form-control input-tip datetime" id="receive_date" required="required"'); ?>
            </div>
