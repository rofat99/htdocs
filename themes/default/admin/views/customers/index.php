                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th class=""><?= lang("company"); ?></th>
                            <th ><?= lang("name"); ?></th>
                            <th class=""><?= lang("email_address"); ?></th>
                            <th class=""><?= lang("phone"); ?></th>
                            <th class=""><?= lang("price_group"); ?></th>
                            <th  class=""><?= lang("customer_group"); ?></th>
                            <th  class=""><?= lang("vat_no"); ?></th>
                            <th class=""><?= lang("deposit"); ?></th>
                            <th  class=""><?= lang("award_points"); ?></th>
