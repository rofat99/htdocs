...
class Pos_model extends CI_Model
{
    ...
    {
        $this->db->select('products.id as id, combo_items.item_code as code, combo_items.quantity as qty, products.name as name,products.test as test,, products.type as type, warehouses_products.quantity as quantity')
